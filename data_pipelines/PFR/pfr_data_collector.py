...
class PFR_Data_Collector(object):
    ...
    def __init__(self):
       ...
       self.raw_data_file     = 'data/raw/NFL_wk_by_wk.csv'
    ...
    def fetch_data(self):
       ...
       self.process.crawl(NFLSpider)
       self.process.start(self)

    def clean_data(self):

       print(f'> Reading in PFR Scrapy data from: {self.raw_data_file}')
       ...
       print(f'> PFR Scrapy data cleaned and written to file: {self.cleaned_data_file}')
