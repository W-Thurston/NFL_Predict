...
const LEGS_STORAGE_KEY = "hm-betslip-v4";
const MODE_STORAGE_KEY = "hm-betslip-mode-v4";
...
export function BetSlipProvider({
  ...
  const add = (leg: BetLeg) => {
    const parsed = parseBetLegV4(leg);
